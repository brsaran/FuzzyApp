...
unless ($@) {
  Log::Log4perl::init('/home/brsaran/etc/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.cgi.utils');
}

my $MOTIF_DB_INDEX = '/home/brsaran/etc/motif_db.index';
my $template_dir = '/home/brsaran/web/cgi-bin';
my $service_invocation_log_dir = '/home/brsaran/LOGS';
my $tmpdir = '';
...
sub verify_opal_job {
  ...
  unless (eval {$result->fault}) {
    ...
    my $query_url = "http://localhost.localdomain/meme/cgi-bin/querystatus.cgi";
